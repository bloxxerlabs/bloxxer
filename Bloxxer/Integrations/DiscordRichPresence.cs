...
using Bloxxer.Models.RobloxApi;
using DiscordRPC;

namespace Bloxxer.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        public void ProcessRPCMessage(Message message, bool implicitUpdate = true)
        {
            ...
            {
                Models.BloxxerRPC.RichPresence? presenceData;

                try
                {
                    presenceData = message.Data.Deserialize<Models.BloxxerRPC.RichPresence>();
                }
                catch (Exception)
                {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            // this is used for configuration from BloxxerRPC
