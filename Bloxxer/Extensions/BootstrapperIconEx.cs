...
namespace Bloxxer.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconBloxxerClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconBloxxer;
            }

            return icon switch
            {
                BootstrapperIcon.IconBloxxer => Properties.Resources.IconBloxxer,
                ...
                BootstrapperIcon.IconBloxxerClassic => Properties.Resources.IconBloxxerClassic,
                _ => Properties.Resources.IconBloxxer
            };
        }
    }
}
