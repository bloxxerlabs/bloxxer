...
using Bloxxer.UI.Elements.Bootstrapper;
using Bloxxer.UI.Elements.Dialogs;

namespace Bloxxer.UI
{
    static class Frontend
    {
        ...
        public static void ShowPlayerErrorDialog(bool crash = false)
        {
            ...
            string info = String.Format(
                ...
                $"https://github.com/{App.ProjectRepository}/wiki/Switching-between-Roblox-and-Bloxxer"
            );
