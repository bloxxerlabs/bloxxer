...
using Bloxxer.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace Bloxxer.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for Bloxxerrpc, discord rich presence, or game history
