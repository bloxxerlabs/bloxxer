...
using Bloxxer.AppData;
using Bloxxer.RobloxInterfaces;
using Bloxxer.UI.Elements.Bootstrapper.Base;
...
namespace Bloxxer
{
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            try
            {
                Mutex.OpenExisting("Bloxxer-Bootstrapper").Close();
                App.Logger.WriteLine(LOG_IDENT, "Bloxxer-Bootstrapper mutex exists, waiting...");
            ...
            await using var mutex = new AsyncMutex(false, "Bloxxer-Bootstrapper");
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Bloxxer instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingBloxxer);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "Bloxxer.exe");
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://github.com/Bloxxerlabs/Bloxxer/wiki/Bloxxer-is-unable-to-download-Roblox](https://github.com/Bloxxerlabs/Bloxxer/wiki/Bloxxer-is-unable-to-download-Roblox)"),
