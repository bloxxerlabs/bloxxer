...
namespace Bloxxer
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Bloxxer-QA";
#else
        public const string ProjectName = "Bloxxer";
#endif
        public const string ProjectOwner = "Bloxxer";
        public const string ProjectRepository = "Bloxxerlabs/Bloxxer";
        public const string ProjectDownloadLink = "https://Bloxxerlabs.com";
        public const string ProjectHelpLink = "https://github.com/Bloxxerlabs/Bloxxer/wiki";
        public const string ProjectSupportLink = "https://github.com/Bloxxerlabs/Bloxxer/issues/new";
        ...
        public static async void SendStat(string key, string value)
        {
            ...
            try
            {
                await HttpClient.GetAsync($"https://Bloxxerlabs.com/metrics/post?key={key}&value={value}");
            }
            catch (Exception ex)
            {
        ...
        public static async void SendLog()
        {
            ...
            try
            {
                await HttpClient.PostAsync(
                    $"https://Bloxxerlabs.com/metrics/post-exception", 
