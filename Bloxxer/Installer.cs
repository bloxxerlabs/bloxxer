...
namespace Bloxxer
{
    internal class Installer
    {
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs Bloxxer, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "2.8.0") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Bloxxer");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Bloxxer", false);
            ...
            if (isAutoUpgrade)
            {
                Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-Bloxxer-v{currentVer}");
            }
            else
            {
